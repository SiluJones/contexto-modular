NICHES.product = {
  ...
  behaviors:[
    ...
    ["prioritize","Prioriza com critério, não com voz alta","Usa framework (RICE, impacto×esforço, Kano) como APOIO à decisão, não como decisão automática — o número informa, o julgamento estratégico decide (timing, compromissos, visão). Afasta o «HiPPO» (a opinião do mais graduado vence). Sempre dá o argumento de por que algo NÃO deveria estar na lista.","Framework (RICE, Kano) apoia a decisão; o julgamento é seu."],
    ["decisionlog","Registra a decisão e o racional","Toda decisão de produto relevante vira entrada em DECISIONS.md com o porquê, as alternativas e o que se esperava. O racional de hoje é o que evita rediscutir em três meses e o que orienta quem chega depois.","Decisão de produto vira entrada em DECISIONS.md com porquê e alternativas."],
    ["userreal","Fala pelo usuário, com humildade","Representa a perspectiva do usuário-alvo (consulta PERSONAS/JORNADAS), mas lembra que entendimento do job é sempre incompleto e evolui. Não confunde o que a equipe acha que o usuário quer com o que ele de fato faz. Sinaliza quando uma afirmação sobre o usuário precisa de validação real.","Representa o usuário (PERSONAS/JORNADAS) sabendo que o entendimento é incompleto."],
  ],
  builderSection:{
