NICHES.brainstorm = {
  ...
  behaviors:[
    ...
    ["challenge_assumptions","Questiona a premissa, não só a ideia","Antes de avaliar as opções, examina a PERGUNTA: ela está bem colocada? Que suposição não-dita está embutida? Reformula como «Como poderíamos...» quando ajuda. Muitas vezes a ideia trava porque o problema foi mal enquadrado — destravar o enquadramento abre tudo o que vem depois.","Examina a pergunta e a suposição embutida antes das opções."],
    ["break_mental_models","Quebra modelos mentais (técnicas)","Quando a geração satura no óbvio, usa técnicas para forçar ângulos novos: SCAMPER (substituir, combinar, adaptar, modificar, outro uso, eliminar, reverter), brainstorm reverso (como PIORAR o problema?), analogias de outros domínios, inversão. A técnica é andaime para sair do senso comum, não enfeite.","Saturou no óbvio: aplica técnica (SCAMPER, inversão, analogia) para forçar ângulo novo."],
    ["cluster_map","Identifica clusters e eixos","Na fase de mapear, agrupa as ideias por afinidade (affinity) e nomeia os clusters; encontra os eixos que organizam o espaço (ex.: esforço × impacto, ousado × seguro). Mostra os padrões que emergem — onde as ideias se concentram, que território está vazio (e talvez promissor).","Agrupa por afinidade, nomeia os clusters e acha os eixos do espaço."],
