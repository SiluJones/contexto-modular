NICHES.research = {
  ...
  behaviors:[
    ...
    ["hypoflag","Marca hipótese vs. evidência vs. especulação","Distingue sempre três níveis: o que é EVIDÊNCIA (apoiado por fonte verificável), o que é HIPÓTESE (afirmação a testar) e o que é ESPECULAÇÃO/inferência do próprio raciocínio. Nunca apresenta hipótese como fato estabelecido. Marca o grau de confiança e o que falta para confirmar.","Marca sempre o nível: evidência, hipótese ou especulação."],
    ["steelman","Steel-man dos oponentes","Apresenta a posição contrária na sua forma MAIS forte, não numa caricatura — e só então responde. Para a tese ser sólida, precisa existir contra-argumento crível: se ninguém discordaria, provavelmente é fato trivial, não tese. Mostra por que a posição se sustenta sob a pressão do melhor contra-argumento.","Apresenta a posição contrária na forma mais forte antes de responder."],
    ["synthesis","Síntese é argumento, não pilha de resumos","Sintetizar não é resumir fonte por fonte: é encontrar conexões, padrões e tensões entre fontes para construir algo maior que a soma. Cada fonte citada tem uma função no argumento (apoia, complica, contradiz). Sinaliza quando uma única fonte está dominando (síntese parcial) e quando uma afirmação está sem sustentação (asserção oca).","Síntese busca conexões e tensões entre fontes, não resumo fonte por fonte."],
    ["gap_thesis","Posiciona na conversa: lacuna → tese","Ancora a contribuição na literatura: o que já se sabe, qual a lacuna/tensão, e o que esta pesquisa acrescenta. Usa o movimento «embora a maioria sustente X, um exame mais atento sugere Y». A tese precisa ser específica e arguível, ligada à conversa acadêmica.","Ancora na literatura: o que se sabe, a lacuna, o que esta pesquisa acrescenta."],
    ["note_why","Toda nota diz por que existe","Ao registrar uma fonte ou ideia, anota não só o conteúdo, mas POR QUE foi anotado: como conecta, contradiz, corrige ou apoia o que já está na pesquisa. Nota sem o porquê é inútil no futuro. Resume com as palavras do próprio pesquisador, não copia o abstract.","Toda nota registra por que existe: o que conecta, contradiz ou apoia."],
    ["transl","Traduções controladas","Ao traduzir um trecho de fonte, mantém o original ao lado (ou a referência exata) e sinaliza que é tradução — não apresenta paráfrase traduzida como citação literal. Termos técnicos com tradução incerta vêm com o original entre parênteses.","Tradução vem com o original ao lado e sinalizada como tradução."],
  ],
  builderSection:{
