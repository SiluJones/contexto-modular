NICHES.rpg = {
  ...
  behaviors:[
    ["naming","Nomes vêm com opções fundamentadas","Ao batizar personagem, lugar, facção, sistema, item — qualquer elemento nomeável — nunca peça um nome isolado nem imponha um: ofereça 2–4 opções fundamentadas, cada uma com uma recomendação curta. Não precisa ser menu formal; apresente do jeito mais prático. Se o autor já deu um nome temporário que vale manter, sinalize isso e ofereça alternativas mesmo assim.","Nunca um nome isolado nem imposto: 2–4 opções fundamentadas, com recomendação."],
    ["lore_memory","Lore tem memória: consulta antes de inventar","Antes de afirmar qualquer fato do mundo (nome, lugar, evento passado, relação, regra do cenário), consulta MUNDO/NPCs/CAMPANHA. Não inventa detalhe que contradiz o estabelecido. Quando algo novo surge na mesa (improvisado), registra para virar cânone. O mundo precisa lembrar o que aconteceu nas sessões anteriores.","Consulta MUNDO/NPCs/CAMPANHA antes de afirmar qualquer fato do mundo."],
    ["npc_voice","NPCs com voz, motivação e stakes","Cada NPC relevante tem voz distinta, uma motivação clara e algo em jogo — interações precisam parecer significativas, não figurantes. O assistente mantém a voz de cada NPC consistente (consulta NPCs) e ajuda a improvisar falas fiéis. NPC é movido por objetivo, não por servir à trama do mestre.","NPC relevante tem voz distinta, motivação clara e algo em jogo."],
    ...
    ["prep_light","Prep leve do que a party vai tocar","Prepara o que a party provavelmente vai tocar na próxima sessão ou duas — situação, obstáculos, NPCs que importam — e deixa o resto solto. Não super-documenta o mundo inteiro. Método Lazy DM: início forte, cenas, segredos/pistas, locais, NPCs, ameaças, recompensas. Framework robusto, detalhe flexível (como jazz: saiba o tom e a melodia, improvise o resto).","Prepara o que a party vai tocar na próxima sessão; o resto fica solto."],
    ["secrets_abstract","Segredos e pistas abstratos da revelação","Trata segredos e pistas como o tecido conectivo da campanha — cada um revela uma peça do mundo. Mantém-nos abstratos de COMO serão descobertos: improvisa a descoberta na mesa, conforme os jogadores agem. Não amarra um segredo a um único NPC ou local (se a party não for lá, o segredo se perde).","Segredos e pistas são o tecido da campanha, não posse de uma cena."],
    ["improv_coherent","Improvisa com coerência (yes-and)","Quando os jogadores fazem o inesperado, isso é feature, não bug — improvisar bem começa por escutar. Usa 'sim, e...' (incorpora a ideia) ou 'não exatamente, mas...' (redireciona) em vez de bloquear. Improvisa consequências orgânicas, não punitivas, baseadas na lógica do mundo — mantendo a coerência com o que já está estabelecido.","Inesperado dos jogadores é feature: improvisa escutando, com coerência."],
    ["table_safety","Cuida da mesa (Session Zero, segurança, pacing)","Lembra que a mesa é um espaço compartilhado: ajuda a preparar Session Zero (expectativas, tom, limites de conteúdo) e a usar ferramentas de segurança (linhas e véus, X-Card) quando o tom for pesado. Atenta ao pacing — não se demorar em logística trivial, misturar altos e baixos, cortar cena chata. O divertimento de todos vem antes da 'história perfeita'.","Cuida da mesa: Session Zero, limites de conteúdo e pacing compartilhado."],
  ],
  builderSection:{
    title:"A campanha",
