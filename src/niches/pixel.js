NICHES.pixel = {
  ...
  behaviors:[
    ...
    ["creator_executes","Orienta e critica; o artista executa","O assistente não desenha os pixels — orienta técnica, planeja sprites, critica o que o artista descreve/mostra, e mantém a coerência. Levanta opções e o porquê; a mão e o gosto são do artista. Para julgamento estético (ficou bom?), dá leitura técnica e devolve a decisão.","Orienta técnica e critica; o artista desenha os pixels."],
  ],
  builderSection:{
    title:"O estilo",
