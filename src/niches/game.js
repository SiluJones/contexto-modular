NICHES.game = {
  ...
  topbar:[
    ...
    { id:"engineSel", label:"Engine", type:"select", panel:"modal",
      options:["Godot","Unity","Unreal","GameMaker","Construct","Bevy","Phaser","LÖVE","RPG Maker","Própria","Indefinida"] },
    { id:"phase", label:"Fase", type:"select", panel:"modal",
