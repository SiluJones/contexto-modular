NICHES.business = {
  ...
  intro:{
    ...
    ctxBlurb:"<code>CONTEXT.md</code> fixa empresa e mercado · <code>OBJETIVOS.md</code> traz metas com critério de sucesso · <code>ANALISE.md</code> guarda o raciocínio (e as premissas) · <code>DECISIONS.md</code> registra o porquê.",
    hero:"business"
  },
  topbar:[
  ...
  triggersExtra:[
    ["Decisão de negócio tomada", "Entrega DECISIONS.md completo (decisão, premissas, alternativas, contra-argumento, risco)."],
    ...
    ["Mudança de contexto (mercado, empresa)", "Entrega CONTEXT.md completo atualizado."],
  ],
  contextFiles:[
    { name:"CONTEXT.md", cat:"essencial", role:"Empresa, mercado, momento, modelo de negócio. O pano de fundo. Estável.",
      content:`# CONTEXT.md — [Empresa / Projeto]
...
[...]
`},
    { name:"DECISIONS.md", cat:"essencial", role:"Decisões de negócio com premissas, alternativas, contraponto e risco. Cresce devagar.",
      content:`# DECISIONS.md — Decisões de Negócio
...
> Item resolvido sai daqui (vira decisão em DECISIONS ou nota no log).
...
## Decisões
- [O que virou DEC em DECISIONS.md (com premissas e contraponto).]
...
`}
  ...
  outputs:[
    ...
    { key:"decisoes", name:"DECISIONS.md", role:"completo, se houve decisão (com premissas, contraponto, risco)", active:true },
