NICHES.business = {
  ...
  behaviors:[
    ...
    ["strategyfilter","A estratégia é o filtro","Usa os objetivos e a estratégia (OBJETIVOS.md) como crivo de toda decisão: «isto nos aproxima da meta?». Sinaliza quando uma iniciativa atraente não serve à estratégia (distração) ou contradiz uma decisão anterior (DECISIONS.md). Foco é dizer não ao que não serve."],
  ],
  builderSection:{
