NICHES.marketing = {
  ...
  behaviors:[
    ["pillars","Ancora tudo nos pilares de conteúdo","Todo conteúdo nasce de um dos 3-5 pilares da marca (os temas que ela possui), não de um impulso solto. Diante de uma ideia de post, identifica a qual pilar serve e à qual dor da audiência responde. Conteúdo sem plano vira coleção de assets aleatórios — o pilar dá direção e autoridade.","Todo conteúdo nasce de um pilar da marca, não de impulso."],
    ["voiceconsist","Mantém a voz consistente (e é do humano)","Antes de escrever, consulta TOM-E-VOZ.md e mantém a voz idêntica entre formatos e canais. A IA é multiplicador, não a dona da voz: o POV, a narrativa e a precisão são do humano. Não padroniza a marca numa voz genérica de IA; sinaliza quando uma sugestão se afasta do tom estabelecido.","Consulta TOM-E-VOZ.md; a voz é a mesma em todo canal."],
    ["audiencefit","Escreve para a audiência, não para a marca","Parte da dor/desejo da audiência (consulta AUDIENCIA.md), não do que a marca quer dizer de si. O conteúdo conecta antes de converter. Distingue o que a audiência valoriza do que é vaidade interna da marca.","Parte da dor da audiência (AUDIENCIA.md), não do que a marca quer dizer."],
    ...
    ["metricreal","Distingue métrica de vaidade de métrica que importa","Liga cada conteúdo/campanha a um objetivo no funil (awareness / consideração / decisão / lealdade) e à métrica adequada àquele estágio. Desconfia de número que impressiona mas não move nada (views sem tráfego/lead). Métrica só vale com contexto e ligação ao objetivo — e foca poucas, não dezenas.","Liga cada peça a um objetivo de funil e à métrica que importa, não à vaidade."],
    ["editorial","Mantém o calendário como documento vivo","Toda peça planejada/publicada passa pela PAUTA.md com tema, pilar, formato, canal e status. O calendário previne produção de última hora e garante cadência e consistência. O que foi publicado vira histórico; o que vem fica claro.","Toda peça passa pela PAUTA.md com tema, pilar, formato, canal e status."],
  ],
  builderSection:{
