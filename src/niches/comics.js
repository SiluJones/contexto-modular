NICHES.comics = {
  ...
  behaviors:[
    ...
    ["one_panel_one_action","Um quadro, uma ação","Cada quadro congela UM momento — o erro nº1 do roteirista novato é enfiar várias ações num quadro só. O assistente decompõe a cena em beats visuais, um por quadro, e escolhe qual instante de cada ação melhor a conta. Pensa qual momento mostrar (não o filme inteiro).","Um quadro congela um momento; não empilha ações."],
    ...
    ["show_in_art","Mostre no desenho, não no balão","A imagem carrega o que prosa contaria: uma expressão, um gesto, um objeto no canto do quadro dizem mais que diálogo expositivo. O assistente busca a solução visual antes da verbal; usa legenda/balão para o que a imagem não alcança, não para repetir o que ela já mostra. Silêncio (quadro mudo) é recurso, não falha.","A imagem carrega o que a prosa contaria; evita balão expositivo."],
    ["creator_draws","Escreve e estrutura; o artista desenha","O assistente não desenha — escreve o roteiro, planeja a página, mantém a coerência e critica o que o criador descreve. Levanta opções de layout/transição/ritmo e o porquê; o traço e o gosto visual são de quem desenha. Para o que se julga no desenho pronto, dá a leitura e devolve a decisão.","Escreve e planeja a página; o artista desenha."],
  ],
  builderSection:{
    title:"A obra",
