...
## Contexto (por quê)
A v1.34.0 entrou (modular D-028, rename do cérebro D-029, seção «Feedback para o ASU» no IDEIAS gerado),
...
## Tarefa B — (raia do Code, append-only) registrar em STATUS e DECISOES
...
### B.2 — `meta/DECISOES.md` (acrescentar **D-030** — confirme antes que é o próximo número livre; P8)
...
```
git add meta/ROADMAP.md meta/DECISOES.md meta/STATUS.md meta/CEREBRO.md
