...
## Tarefa B — "Feedback para o ASU" no IDEAS gerado
No template de `IDEAS.md` que o kit gera, ache a seção **"Feedback para o Kit"** e adicione
...
- Abrir o `index.html` e conferir em 1 nicho: o arquivo gerado do cérebro sai como **`CEREBRO.md`**;
  o IDEAS gerado tem **"Feedback para o Kit"** e, abaixo, **"Feedback para o ASU"**.
...
- **`meta/DECISIONS.md`**: acrescente (na sequência de numeração existente) **duas** decisões:
...
- **Commit** (uma linha, **sem acento**):
  `git commit -m "feat: cerebro renomeado para CEREBRO.md + secao Feedback para o ASU no IDEAS gerado" -m "Libera CLAUDE.md para o arquivo-raiz do Claude Code; harness atualizado; saida 17/17"`
