...
### 2026-07-29 — WO da trava por configuração (opção C da análise do teto) — A ESCREVER (wo0069, D-103)
A wo0069 aplicou a opção **(D)** (curar as linhas de modo) e mediu o resultado: incremento máximo do **+Code** caiu de 779 para **529**, do **+ASU** de 690 para **372**, nichos acima do teto no combo caíram de 13/18 para 2/18. O autor aceitou a opção **(C)** (teto por configuração) **depois de (D)** — é a WO seguinte, e já sai com números recomendados em vez de a decidir do zero: **Code ≤ 550 · ASU ≤ 400**, «apertado» na definição útil (já cumprido hoje, então a próxima linha de modo só entra se outra for curada — o «folgado» de 800/600 legitimaria de volta o que a wo0069 acabou de cortar). O total no combo cheio ganha uma **tolerância documentada de 7.600** (o mesmo pior-caso que o `G16` já usa), que `narrative` (7.529) e `game` (7.437) cumprem. **Decisão já tomada, não a reabrir nesta WO:** o `G16` **não** deve virar o check de tudo — ele mede o pior caso de **conteúdo** (chips/multi) e continua assim; os modos ganham check próprio (o C26 desta WO), porque a diferença é conceitual — trava o **incremento**, não o total (que varia com a riqueza do nicho, fora do controle do kit). Esta WO substitui o item da wo0065 acima («O teto não cobre os modos»), que fica fechado por ela.
