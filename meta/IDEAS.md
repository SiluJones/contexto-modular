...
## i-N40 — Modo Atualização: empacotar o nicho ativo (achatado + afixado + prompt) para subir num gesto a um projeto KCM existente — 🚧 EM ANDAMENTO — Fase A ✅ CONCLUÍDA (spec0035), Fase B ✅ CONCLUÍDA (spec0036), Fase C pendente (2026-07-07)
